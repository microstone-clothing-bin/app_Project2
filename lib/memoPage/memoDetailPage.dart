...
import 'package:microstone_clothing_bin/memoPage/memoDB.dart';
...
class _ContentState extends State<ContentPage> {
  ...
  Future<void> updateItemEvent(BuildContext context) {
    ...
    TextEditingController titleController = TextEditingController(
      text: memoInfo[0]['memoTitle'],
    );
    TextEditingController contentController = TextEditingController(
      text: memoInfo[0]['memoContent'],
    );
  ...
  void deleteItemEvent(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MyMemoPage()),
    );
  }
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: Text(memoInfo[0]['memoContent']),
                          ),
                        ),
                      ),
                    ],
